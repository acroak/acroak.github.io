$(() => {
  ...
  $(document).ready(function () {
    $("#email-icon").mouseover(function () {
      $(this).attr(
        "src",
        "images/social_icons/if_mail_email_envelope_send_message_blk.png"
      );
    });
    $("#email-icon").mouseout(function () {
      $(this).attr(
        "src",
        "images/social_icons/if_email_mail_envelope_send_message_1011336.png"
      );
    });
  });
  ...
  $(document).ready(function () {
    $("#github-icon").mouseover(function () {
      $(this).attr(
        "src",
        "images/social_icons/if_social_media_logo_github_blk.png"
      );
    });
    $("#github-icon").mouseout(function () {
      $(this).attr(
        "src",
        "images/social_icons/if_github_social_media_logo_1221583.png"
      );
    });
  });
  ...
  $(document).ready(function () {
    $("#linkedin-icon").mouseover(function () {
      $(this).attr(
        "src",
        "images/social_icons/if_linked_in_online_social_media_blk.png"
      );
    });
    $("#linkedin-icon").mouseout(function () {
      $(this).attr(
        "src",
        "images/social_icons/if_online_social_media_linked_in_734383.png"
      );
    });
  });
  ...
  $(document).ready(function () {
    $("#instagram-icon").mouseover(function () {
      $(this).attr(
        "src",
        "images/social_icons/if_instagram_online_social_media_photo_blk.png"
      );
    });
    $("#instagram-icon").mouseout(function () {
      $(this).attr(
        "src",
        "images/social_icons/if_instagram_online_social_media_734394.png"
      );
    });
  });
